...
import { DeployTemplateModalProps } from "../../../types";
import { useDeployTemplateForm } from "../../../hooks/infrastructure/templates/useDeployTemplateForm";

export const DeployTemplateModal = ({
  isOpen,
  onClose,
  onSubmit,
  onCancel,
