...
export const useRoleVerification = (dict: any) => {
      ...
      try {
        ...
        if (profileType === "Designer") {
          ...
          if (
            ...
            errorMessage = dict?.youAreNotVerifiedAsDesigner;
          }
          ...
          if (
            ...
            errorMessage = dict?.youAreNotVerifiedAsSupplier;
          }
          ...
          if (
            ...
            errorMessage = dict?.youAreNotVerifiedAsFulfiller;
          }
        }
        ...
        context.showError(dict?.errorVerifyingRole);
        return false;
      }
    },
    [context]
