    ...
    <>
      {item.metadata.description && (
        <div className="border border-white rounded-sm p-6">
          <h3 className="text-lg font-herm text-white mb-3">Description</h3>
          <p className="text-white leading-relaxed">{item.metadata.description}</p>
        </div>
      )}

      <div className="border border-white rounded-sm p-6">
        <h3 className="text-lg font-herm text-white mb-4">AI Generation Details</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {item.metadata.prompt && (
            <div>
              <h4 className="text-ama font-herm mb-2">Prompt</h4>
          ...
          {item.metadata.aiModel && (
            <div>
              <h4 className="text-ama font-herm mb-2">AI Model</h4>
          ...
          {item.metadata.workflow && (
            <div>
              <h4 className="text-ama font-herm mb-2">Workflow</h4>
          ...
          {item.metadata.version && (
            <div>
              <h4 className="text-ama font-herm mb-2">Version</h4>
          ...
          {item.metadata.loras && item.metadata.loras.length > 0 && (
            <div>
              <h4 className="text-ama font-herm mb-2">LoRAs</h4>
          ...
          {item.metadata.tags && item.metadata.tags.length > 0 && (
            <div>
              <h4 className="text-ama font-herm mb-2">Tags</h4>
              <div className="space-y-1">
              ...
              <div key={index} className="bg-black/20 border border-white/30 rounded-sm p-4">
                <div className="text-sm">
                  <div className="flex justify-between mb-2">
                    <span className="text-ama">Type:</span>
